...
public class Sender extends BaseEntity {
    private static final long serialVersionUID = -7591908807678834819L;
    private String name;
    ...
    public Sender(String name, String postCode, String phone, String mobile, String prov, String city, String address) {
        this.name = name;
